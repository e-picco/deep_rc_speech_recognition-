function fpga_send_data(pattern, mask)
    ...
    [msk_fpga, msk_debug] = fpga_real_to_fpga(mask, 15); %R: d.wi*hp.inp  (mask*inp) is converted in an array of bytes (each value of masked input is converted in 2 bytes)
